...
def modify_sales_confirmation(invoice_data, template_path, output_dir, user_inputs):
    ...
    try:
        ...
        # ============== 构建常规替换字典 ==============
        replacements = {
            "Company1": "惠州市致嘉模具有限公司",
            "东莞市横沥镇桃子园高新产业园": "博罗县龙溪街道长湖村梅花岭经济合作社、长湖经济合作社位于罗竹岭、指挥部、大坑（土名）地段",
            "0769-89202666": "",
...
def create_export_declaration(invoice_data, template_path, output_dir, user_inputs):
    ...
    try:
        ...
        replacements = {
            ...
            "IFEE": insurance,
            "OFEE": other_fees,
            "境内发货人:441996482N\n 东莞致嘉金属科技有限公司91441900590063932M": "境内发货人:4413960FRK                                                      惠州市致嘉模具有限公司 91441322MAELYTFD8K",
            "生产销售单位\n441996482N\n 东莞致嘉金属科技有限公司91441900590063932M": "生产销售单位\n4413960FRK\n 惠州市致嘉模具有限公司 91441322MAELYTFD8K",
            "东莞": "惠州",
        }
